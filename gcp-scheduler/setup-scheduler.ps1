...
# Job 2: Vote & Payment Reminders (Daily 10:00 AM PST)
Write-Host "2. Creating vote-payment-reminders (Daily 10:00 AM PST)..."
...
gcloud scheduler jobs create http vote-payment-reminders `
    ...
    --description="Triggers daily vote and payment reminders at 10am PST"
